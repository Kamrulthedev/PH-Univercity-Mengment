...
import { TCoures, TCouresFaculty, TPerRequisiteCourses } from "./Coures.interface";
...
export const CouresFaculty = model<TCouresFaculty>("CouresFaculty", courseFacultiesSchema);
