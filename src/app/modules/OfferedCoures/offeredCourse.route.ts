...
router.post(
  ...
  validationRequest(
    offeredCouresValidation.createOfferedCourseValidationSchema,
  ),
  OfferedCurseControllar.createOfferedCourseDb,
);
...
router.patch(
  "/:id",
  validationRequest(
    offeredCouresValidation.updateOfferedCouresValidationSchema,
  ),
  OfferedCurseControllar.UpadateOfferedCourseDb,
);
