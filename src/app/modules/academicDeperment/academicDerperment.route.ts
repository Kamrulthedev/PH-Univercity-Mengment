...
router.post('/create-academic-deperment',validationRequest(AcademicDerpermentValidation.createAcademicDapermentValidation), AcademicDepermantControllar.createAcademicDerpermentDb);
